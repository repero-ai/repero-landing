...
const entries: Entry[] = [
  ...
  { path: '/en/legal', alternates: [{ lang: 'fr', path: '/fr/mentions-legales' }] },
  { path: '/fr/mentions-legales', alternates: [{ lang: 'en', path: '/en/legal' }] },
  { path: '/en/cookies', alternates: [{ lang: 'fr', path: '/fr/politique-cookies' }] },
  { path: '/fr/politique-cookies', alternates: [{ lang: 'en', path: '/en/cookies' }] },
