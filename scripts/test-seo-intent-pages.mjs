...
const pages = [
  {
    ...
    requiredCopy: 'Vous pouvez passer de GPT à Claude ou Mistral'
  },
  {
    ...
    requiredCopy: 'Move between GPT, Claude and Mistral'
  },
  {
    ...
    requiredCopy: 'Repero AI vous permet de travailler avec GPT, Claude et Mistral'
  },
  {
    ...
    requiredCopy: 'Repero AI lets you work with GPT, Claude and Mistral'
  },
  {
    ...
    requiredCopy: 'Repero AI réunit GPT, Claude et Mistral dans un espace de travail européen'
  },
  {
    ...
    requiredCopy: 'Repero AI brings GPT, Claude and Mistral into a European workspace'
  }
];
...
for (const page of pages) {
  ...
  expect(html, page.requiredCopy, `${page.file} core model copy`);
